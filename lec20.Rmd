...
Consider a Uniform[0,1] distribution. The mean is 0.5 and the standard deviation is $1/\sqrt{12}$. Here is a plot of a uniform density versus a $N(0.5, 1/\sqrt{12})$ density:

```{r}
x <- -50:150/100
plot(x, dnorm(x, 0.5, 1/sqrt(12)), type="l", col="blue", ylab="density", cex=1.5)
lines(x, dunif(x), col="red")
legend(1, 1.4, legend = c("Normal", "Uniform"), fill=c("blue", "red"), )
```
...
source("bates.R")
n <- 2
plot((x-0.5)*sqrt(12*n), dnorm((x-0.5)*sqrt(12*n)), type="l", col="blue", ylab="density", cex=1.5, xlab="x")
lines((x-0.5)*sqrt(12*n), dbates(x, 2)/sqrt(12*n), col="red")
legend(2, 0.4, legend = c("Normal", "Uniform X-bar standardized"), fill=c("blue", "red"), )
```
...
```{r}
n <- 5
plot((x-0.5)/sqrt(12*n), dnorm((x-0.5)*sqrt(12*n)), type="l", col="blue", ylab="density", cex=1.5, xlab="x", xaxt='n')
lines((x-0.5)/sqrt(12*n), dbates(x, n)/sqrt(12*n), col="red")
legend(2, 0.4, legend = c("Normal", "Uniform X-bar standardized"), fill=c("blue", "red") )
```
...
Now let the "underlying" distribution be Exp$(1)$, which has mean and standard deviation both equal to $1/1=1$. Here's the density along with a $N(1,1)$ density:

```{r}
x <- -50:600/100
plot(x, dnorm(x, 1, 1), type="l", col="blue", ylab="density", cex=1.5, ylim=c(0,1.1))
lines(x, dexp(x), col="red")
legend(1, 1.4, legend = c("Normal", "Exp"), fill=c("blue", "red") )
```
...
x <- seq(0.1,6, by=0.1)
n <- 2
plot(x, dnorm(x, n, 1/sqrt(n)), type="l", xaxt='n', yaxt='n', col="blue", ylab="density")
lines(x, dgamma(x, n, 1), col="red")
legend(3.5, 0.4, legend = c("Normal", "Exp X-bar standardized"), fill=c("blue", "red") )
```
...
x <- seq(0, 21, by=0.1)
n <- 10
plot(x, dnorm(x, n, sqrt(n)), type="l", xaxt='n', yaxt='n', col="blue", ylab="density")
lines(x, dgamma(x, n, 1), col="red")
legend(13, 0.12, legend = c("Normal", "Exp X-bar standardized"), fill=c("blue", "red") )
```
...
plot(x, dnorm(x, n, sqrt(n)), type="l", xaxt='n', yaxt='n', col="blue", ylab="density")
lines(x, dgamma(x, n, 1), col="red")
legend(70, 0.05, legend = c("Normal", "Exp X-bar standardized"), fill=c("blue", "red") )
```
